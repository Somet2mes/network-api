            ...
            if step == end - 1 {
                ...
                track(
                    ...
                    json!({
                        ...
                        "k": k,
                        "proof_duration_sec": total_duration.as_secs() as f64 / 30.0,
                        "proof_duration_millis": total_duration.as_millis() as f64 / 30.0,
                        "proof_cycles_per_minute": proof_cycles_per_minute * 30.0,
